...
{
	// If Test1 is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in Test1.Build.cs is not automatically propagated
